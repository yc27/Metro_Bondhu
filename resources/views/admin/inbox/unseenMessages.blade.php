        ...
        <div class="row m-0">
            <div class="col-11 pl-0">
                <div class="row m-0 d-flex align-items-baseline">
                    ...
                    <div class="col-md-auto pl-0 header-title h6 light-blue-text">
                        {{ $message->email }}
                    </div>
                </div>
...
<div class="card">
    <div class="card-body text-center info-color rounded pt-2 pb-0">
        <div class="mb-2">Showing <b>{{$unseen_messages->count()}}</b> out of <b>{{$unseen_messages->total()}}</b> Messages</div>
        <div class="mx-auto unseen-messages" style="width: fit-content">{{ $unseen_messages->links() }}</div>
    </div>
</div>